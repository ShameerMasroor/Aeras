...
public:
  ...
  void InitSubscribers(
    ...
    std::string slam_pose_topic_ = "/lio_pose", // Add SLAM pose topic);
    std::string cmd_quat_topic_ = "/cmd_quat");
  void InitPublishers(
  ...
  // In plugin_drone_private.h
  void CmdQuatCallback(const geometry_msgs::msg::Quaternion::SharedPtr msg);
...
private:
  ...
  geometry_msgs::msg::Pose slam_pose_; // SLAM pose
  geometry_msgs::msg::Quaternion cmd_quat;
  ...
  rclcpp::Subscription<geometry_msgs::msg::Pose>::SharedPtr slam_pose_subscriber_{nullptr}; // Subscriber for SLAM pose
  rclcpp::Subscription<geometry_msgs::msg::Quaternion>::SharedPtr cmd_quat_subscriber_;
