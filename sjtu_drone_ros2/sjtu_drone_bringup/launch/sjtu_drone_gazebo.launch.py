...
def generate_launch_description():
    ...
    world_file = os.path.join(
        get_package_share_directory("sjtu_drone_description"),
        "worlds", "green_playground5.world"
    )

    # Set the custom GAZEBO_MODEL_PATH
    gazebo_model_path = "/usr/share/gazebo-11/models" #for a global path to the models in the computer
    # gazebo_model_path = "../../sjtu_drone_description/tree_models" #for a relative path
