...
#         DeclareLaunchArgument('input_cloud_topic', default_value='/simple_drone/scan'),
#         DeclareLaunchArgument('resolution', default_value='0.5'),
#         DeclareLaunchArgument('frame_id', default_value='world'),
#         DeclareLaunchArgument('base_frame_id', default_value='simple_drone/base_link'),
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('incremental_2D_projection', default_value='True'),
        DeclareLaunchArgument('sensor_model/max_range', default_value='-1.0'),
        DeclareLaunchArgument('sensor_model/hit', default_value='0.85'),
        DeclareLaunchArgument('sensor_model/miss', default_value='0.3'),
        DeclareLaunchArgument('sensor_model/min', default_value='0.12'),
        DeclareLaunchArgument('sensor_model/max', default_value='0.97'),
        DeclareLaunchArgument('color/r', default_value='0.0'),
        ...
        DeclareLaunchArgument('color_free/a', default_value='1.0'),
        DeclareLaunchArgument('publish_free_space', default_value='True'),
        DeclareLaunchArgument('use_sim_time', default_value='True'),  # Add use_sim_time argument
        Node(
            package='octomap_server2',
            executable='octomap_server',
            output='screen',
            ...
            parameters=[{'resolution': LaunchConfiguration('resolution'),
                         ...
                         'color_free/a': LaunchConfiguration('color_free/a'),
                         'publish_free_space': LaunchConfiguration('publish_free_space'),
                         'use_sim_time': LaunchConfiguration('use_sim_time')}  # Pass use_sim_time to node
            ]
        ),

        Node(
        package='octomap_server2',  # Change this to the actual package name
        executable='octomap_analyzer',
        output='screen',
